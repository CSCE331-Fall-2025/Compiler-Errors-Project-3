            ...
            <section className="popular-section">
                <div className="popular-content-grid">
                    ...
                    <div className="popular-left">
                        ...
                        <p className="popular-review">I don't understand the bad reviews, place is great, workers were very kind, good ambiance, and the best food out of every Panda Express I've been to.</p>
                    </div>
